...
let proxyIP = 'proxyip.dabo.us.kg';// 小白勿动，该地址并不影响你的网速，这是给CF代理使用的。'cdn.xn--b6gac.eu.org, cdn-all.xn--b6gac.eu.org, workers.cloudflare.cyou'

let sub = 'sub.xf.free.hr';// 避免项目被滥用，现已取消内置订阅器
